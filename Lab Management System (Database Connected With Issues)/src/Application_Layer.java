...
abstract class User {
    ...
    protected User() {
        ...
        // Don't call setters to avoid validation
    }
    ...
    // Special method for setting pre-encrypted password from database
...
class Student extends User {
    // Default constructor for reflection-based instantiation
    public Student() {
        super();  // Use parent's default constructor that doesn't validate
    }
