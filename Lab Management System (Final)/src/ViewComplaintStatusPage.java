...
public class ViewComplaintStatusPage {
    ...
    public void initialize(Stage stage) {
        ...
        controller.initializeSampleComplaints();
        
        // Fetch complaints from the database
        complaints = FXCollections.observableArrayList(controller.getAllComplaints());
        ...
        refreshBtn.setOnAction(e -> {
            complaints.clear();
            complaints.addAll(controller.getAllComplaints());
        ...
        searchBtn.setOnAction(e -> {
            ...
            // Refresh complaints list from database before searching
            complaints.clear();
            complaints.addAll(controller.getAllComplaints());
            table.setItems(complaints);
